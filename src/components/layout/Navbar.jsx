import {faBars, faBell, faClock, faCog, faSearch, faUser} from '@fortawesome/free-solid-svg-icons';
import {FontAwesomeIcon} from '@fortawesome/react-fontawesome';

const backgroundColor = "linear-gradient(90deg, rgba(50,4,4,1) 12%, rgba(121,9,18,1) 35%, rgba(170,1,32,1) 61%)";

const Navbar = ({handleSiderHidden, handleMenu}) => {
  return (
    <nav className="navbar navbar-main navbar-expand-lg px-0 px-2 shadow-none" id="navbarBlur" navbar-scroll="true" style={{background: "rgb(50,4,4);", background: backgroundColor}}>
    ...
    <div onClick={ handleMenu }>
        ...
        <nav aria-label="breadcrumb">
          <ol className="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li className="breadcrumb-item text-sm">
              <a href="" className="opacity-5 text-white active" aria-current="page">Dashboard</a>
            </li>
          </ol>
